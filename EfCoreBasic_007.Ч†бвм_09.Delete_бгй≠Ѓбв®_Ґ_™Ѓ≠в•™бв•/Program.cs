...
namespace EfCoreBasic_007.Часть_09.Delete_сущности_в_контексте
{
    public class Program
    {
        ...
        public static void Удаление_сущности_в_контексте()
        {
            using var dbContext = new ApplicationDbContext();

            var firstCourse = dbContext
                .Courses
                .First();
